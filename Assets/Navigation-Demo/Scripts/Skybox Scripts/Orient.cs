...
/// </summary>
[System.Obsolete("Remnant from using separate camera to render skybox")]
public class Orient : MonoBehaviour {
    ...
    void Update () {
         ...
         */
        transform.Rotate(Vector3.up, Time.deltaTime * sun.GetComponent<Sun>().gameHoursPerRealSecond * (float) earthAngularVelocity, Space.World);
